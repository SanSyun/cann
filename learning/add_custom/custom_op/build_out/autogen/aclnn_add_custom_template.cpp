...
#include "AddCustomTemplate_op_resource.h"
...
[[maybe_unused]] uint32_t NNOPBASE_AddCustomTemplate = 0U;
} // namespace
...
#ifdef ACLNN_WITH_BINARY
    static uint32_t AddCustomTemplateOpTypeId = op::GenOpTypeId("AddCustomTemplate", AddCustomTemplate_RESOURCES);
#endif
    static NnopbaseDfxId dfxId = {0x60000, __func__, false};
    static NnopbaseDfxId tilingId = {0x60000, "aclnnAddCustomTemplateTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "AddCustomTemplate";
    char inputDesc[] = {1, 1};
    char outputDesc[] = {1};
    char attrDesc[] = {};
...
#ifdef ACLNN_WITH_BINARY
    NnopbaseAddOpTypeId(*executor, AddCustomTemplateOpTypeId);
#endif
